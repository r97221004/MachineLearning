...
np.set_printoptions(8) # 小數點設 8 位
...
get_ipython().run_line_magic('pinfo', 'combinations')


# In[101]:


get_ipython().run_line_magic('pinfo', 'clone')
...
get_ipython().system(' python ../.convert_notebook_to_script.py --input ch04.ipynb --output ch04.py')
